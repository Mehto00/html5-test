...
const participantsTableHeader = (props) => {
  ...
  const hoverStyling = {
    ...
    <div className="participantsTableHeader">
      <div className="participantsTableHeader__FirstRow">
        <div className="participantsTableHeader__col participantsTableHeader__col__content participantsTableHeader__col__content__name" onClick={() => props.sortBy('name', props.sortByToggle)}>
      ...
      <div className="participantsTableHeader__SecondRow">
